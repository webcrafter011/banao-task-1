...
export default function Navbar() {
  return (
    <nav
      className="navbar navbar-expand-lg bg-white position-sticky top-0 "
      style={{ zIndex: 4 }}
    >
      <div className="container-fluid px-5">
        ...
        <form
          action=""
          className="d-flex flex-row d-none d-lg-block rounded-pill"
          style={{ backgroundColor: "#F2F2F2" }}
        >
          <img className="p-3" src="./images/Vector.png" alt="" />
          <input
            className="tp border-0 rounded-pill"
            type="text"
            style={{
              width: 25 + "rem",
              background: "#F2F2F2",
        ...
        <div className="d-none d-lg-block">
          ...
          >
            IT's free <img src="./images/arrow.png" alt="" />
          </a>
        </div>
