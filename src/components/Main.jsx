  ...
  return (
    <section className="nav2">
      <div className="container flex-column">
        <div
          className="d-flex flex-row justify-content-between border-bottom d-none d-lg-flex position-sticky top-0 "
          style={{
            zIndex: 3,
            paddingTop: 4.5 + "rem",
        ...
        >
          ...
          <div className="d-flex gap-3 pb-2 ">
            <div className="dropdown ">
              <button
                className="btn btn-secondary dropdown-toggle fw-medium border-0"
                type="button"
            ...
            <button type="button" className="btn btn-primary">
              <img src="./images/group.png" alt="" /> Join Group
            </button>
          </div>
        </div>
        ...
        <div className="posts d-flex flex-row">
              ...
              <div className="d-flex flex-column border">
                ...
                <div className="p-3">
                  ...
                  <div className="d-flex flex-row">
                    <p className="fs-3 fw-semibold" style={{ color: "black" }}>
                      What if famous brands had regular fonts? Meet
                      RegulaBrands!
                    </p>
                    <div className="dropdown">
                      <button
                        className="btn bg-white fw-medium border-0"
                        type="button"
                        data-bs-toggle="dropdown"
                        style={{
                          background: "#EDEEF0",
                      ...
                      >
                        <img
                          src="./images/baseline-more_vert-24px.svg"
                          alt=""
                        />
                      </button>
                      <ul className="dropdown-menu">
                  ...
                  >
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center gap-4">
                      <div class="hei-dis d-flex justify-content-center align-items-center">
                        <div>
                          <img
                            src="./images/visibility_24px_outlined.svg"
                            alt=""
                          />{" "}
                          1.4k views
                        </div>
                  ...
                  <div className="d-flex flex-row">
                    <div className="d-flex flex-row">
                      <img
                        ...
                        src="./images/outline-work_outline-24px.png"
                        alt=""
                      />
          ...
          <div
            className="d-flex flex-column d-none d-lg-flex w-25 position-sticky top-2"
            style={{
              paddingLeft: 4 + "rem",
              zIndex: 2,
              paddingTop: 2 + "rem",
          ...
          >
            ...
            <div className="d-flex flex-row gap-1">
              ...
              <div className="pt-1">
                <p className="" style={{ fontSize: 0.9 + "rem" }}>
            ...
            <div className="d-flex flex-row pb-3 justify-content-between">
              <div className="d-flex flex-row justify-content-center align-items-center gap-2">
                <img
                  ...
                  style={{ height: 2.5 + "rem" }}
                />
                <div className="p-1">Activism</div>
              </div>
              <div className="d-flex justify-content-center align-items-center">
                <button
                  className="border-0 rounded-pill"
            ...
            <div className="d-flex flex-row pb-3 justify-content-between">
              <div className="d-flex flex-row justify-content-center align-items-center gap-2">
                <img
                  src="./images/Rectangle-6-3.png"
                  alt=""
                  style={{ height: 2.5 + "rem" }}
                />
                <div className="p-1">Philosophy</div>
              </div>
              <div className="d-flex justify-content-center align-items-center">
                <button
                  className="follow border-0 rounded-pill"
                  style={{
                    paddingTop: 0.2 + "rem",
                    paddingRight: 1 + "rem",
                    paddingBottom: 0.2 + "rem",
